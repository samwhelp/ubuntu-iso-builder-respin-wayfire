...
| `+` | `+` |
| [ubuntu-iso-builder-remix-wayfire](https://samwhelp.github.io/ubuntu-iso-builder-remix-wayfire/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-wayfire) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-wayfire](https://samwhelp.github.io/ubuntu-iso-builder-respin-wayfire/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-wayfire) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-wayfire/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-wayfire/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-wayfire/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-wayfire](https://github.com/samwhelp/ubuntu-iso-builder-respin-wayfire)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-wayfire.git
```


> change dir to `ubuntu-iso-builder-respin-wayfire`

``` sh
cd ubuntu-iso-builder-respin-wayfire
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-wayfire/dist`
